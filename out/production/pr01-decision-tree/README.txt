...
- attribute node (DONE)
    ...
    - decision stored as string
- tree generator should store current dataset
- compute default data at beginning
- have a helper, work with copies of the data
- make a partition method that will return a list of lists of row objects (DONE)

- computations on data in dataset class
- computations on tree in treegenerator class